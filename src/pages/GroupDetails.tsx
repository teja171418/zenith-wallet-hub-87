        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="flex items-center gap-6 flex-1">
            <div className="relative">
              ...
              {groupData.status === 'active' && (
                <div className="absolute -top-2 -right-2 w-6 h-6 bg-emerald-400 rounded-full animate-pulse-glow flex items-center justify-center">
            ...
            <div className="flex-1 space-y-3">
              <div className="flex items-center gap-4 mb-2">
                <h1 className="text-4xl font-bold text-gradient-cyber animate-slide-in-left">{groupData.name}</h1>
                <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/30 px-4 py-1 animate-slide-in-right">
                  {groupData.status}
                </Badge>
              </div>
              <p className="text-white/70 text-lg animate-slide-in-left" style={{ animationDelay: '0.1s' }}>{groupData.description}</p>
              <div className="flex items-center gap-6 text-sm text-white/50 animate-slide-in-left" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex gap-3 animate-slide-in-right">
            <Button 
              ...
              className="btn-cyber text-white px-6 hover-glow transition-all duration-300 hover:scale-105"
            >
              <Plus className="w-5 h-5 mr-2" />
              Add Expense
            </Button>
            {groupData.isOwner && (
              <Button variant="outline" className="border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-300 hover:scale-105">
